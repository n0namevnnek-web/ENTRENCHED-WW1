...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/ENTRENCHED-WW1/refs/heads/main/ENTRENCHED%20WW1", -- The raw URL of your main script
    ...
    HubDescription  = "Entrenched WW1 Script" -- The text shown below the title
}
